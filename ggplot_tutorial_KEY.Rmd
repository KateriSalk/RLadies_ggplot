...
ggplot(PM25, aes(x = DAILY_AQI_VALUE)) +
  geom_histogram()
...
ggplot(PM25, aes(x = DAILY_AQI_VALUE)) +
  geom_histogram() +
  labs(x = "Daily AQI Value", y = "Count", title = "PM 2.5 AQI Values in California") +
  theme_classic()
...
ggplot(PM25, aes(x = Date, y = DAILY_AQI_VALUE)) +
...
```{r}
ggplot(PM25, aes(x = Date, y = DAILY_AQI_VALUE, color = Site.Name)) +
  geom_point(alpha = 0.7) +
  theme_classic() +
  scale_color_manual(values = c("magenta", "steelblue")) +
...
ggplot(PM25, aes(x = Date, y = DAILY_AQI_VALUE, color = Site.Name)) +
  geom_point() +
  facet_wrap(vars(Site.Name), nrow = 2) +
  theme_classic() 
```
...
ggplot(PM25, aes(x = Daily.Mean.PM2.5.Concentration, y = DAILY_AQI_VALUE)) +
...
ggplot(PM25, aes(y = DAILY_AQI_VALUE, x = CBSA_NAME, fill = CBSA_NAME)) +
  #geom_boxplot() +
  geom_violin() +
  geom_hline(yintercept = 50, lty = 10) +
